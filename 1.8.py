...
systeem = None #lege variable zodat ik deze kan gebruiken om systemen in te zetten
...
while True  :
    while True:
        ...
        while True:
            ip = input("Geef een ip address: ") #ip address word gecheckt of het het de juist aantal nummber heeft binnen in juist range
        ...
        Anotherone= input ("wilt u nog een systeem ingeven ja/nee ")
        while Anotherone not in {"ja","nee"}:
         print ("antwoord ja of nee ")
         Anotherone= input ("wilt u nog een systeem ingeven ja/nee ")
        if Anotherone in ("ja"):
         print("volgend systeem")
        else :
            print (systeem)
            break
    ...
    if savesystem in ("nee") :
        print ("niet opgeslagen ")
    restart = input ("wil u opnieuw beginnen ja/nee")
    while  restart not in {"ja","nee"}:
        print ("antwoord ja of nee ")
        restart = input ("wilt u opnieuw beginnen ja/nee ")
    if restart in ("ja"):
        "opnieuw begonnen"
    else :
     print ("we stoppen")     
